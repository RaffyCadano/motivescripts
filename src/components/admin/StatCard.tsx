...
export function StatCard({ stat }: StatCardProps) {
  ...
  return (
    <article className="rounded-[var(--admin-radius)] border border-[var(--admin-line)] bg-[var(--admin-card)] p-5 transition-colors duration-[var(--duration-fast)] hover:border-[rgb(0_80_240_/_0.18)]">

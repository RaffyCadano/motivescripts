import { Ban, Check, CircleDot, FileText, Phone, Sparkles, UserCheck } from "lucide-react";
import type { LeadStatus } from "@/data/leads";
import { cn } from "@/lib/cn";

const styles: Record<LeadStatus, string> = {
  New: "bg-[rgb(0_80_240_/_0.08)] text-[var(--admin-blue)]",
  Contacted: "bg-[rgb(0_80_240_/_0.06)] text-[var(--admin-navy)]",
  ...
  Lost: "bg-[var(--admin-bg)] text-[var(--admin-muted)]",
};

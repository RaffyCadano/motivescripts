...
type ClientNoteModalProps = {
  open: boolean;
  onClose: () => void;
  onSave: (body: string) => void;
};

export function ClientNoteModal({ open, onClose, onSave }: ClientNoteModalProps) {
  ...
  return (
    <AdminDialog
      ...
      description="This note is for the agency only. It never appears in the Client Portal."
      onClose={() => {
        setBody("");
        onClose();
      }}

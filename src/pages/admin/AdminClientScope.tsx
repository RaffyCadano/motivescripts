 ...
 * It is the same form and the same scope record the client sees in their portal; the form keeps the client
 * portal's look so it reads exactly as the client will see it.
 */
  ...
  return (
    <div className="space-y-5">
      ...
      {!hasPermission(profile, "clients.manage") ? (
        ...
        <div className="client-theme max-w-3xl">
          <ScopeFormPage
            client={client}
            staff
            staffActions={

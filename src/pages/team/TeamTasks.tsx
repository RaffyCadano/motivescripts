      ...
      {!openTask ? (
        <>
          ...
          {tasks.length === 0 ? (
            ...
            <>
              <MyTaskTable tasks={visible} onOpen={setOpenTask} projectHref={(id) => teamProjectHref(id, { tab: "tasks" })} />
              <MyTaskMobileList tasks={visible} onOpen={setOpenTask} projectHref={(id) => teamProjectHref(id, { tab: "tasks" })} />
            </>
          )}
        </>
      ) : null}

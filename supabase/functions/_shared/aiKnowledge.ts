 ...
 */
export const AI_KNOWLEDGE_VERSION = "2026-11-02.1";
...
- Hosting: free for the first 30 days after the website goes live, for every package. Keeping the site online after that means a Website Care plan (hosting is included from the Essential tier). Hosting setup for a new project is a separate line item quoted in the proposal.
